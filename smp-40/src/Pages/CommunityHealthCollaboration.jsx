...
import DataCommunityHealthCollaboration from "../Components/Data/DataCommunityHealthCollaboration";

const CommunityHealthCollaboration = () => {
  return (
        ...
        <div className="flex flex-col">
          <div>
            <img
              ...
              src={DataCommunityHealthCollaboration.mainImage}
              alt={DataCommunityHealthCollaboration.title}
            />
          </div>
          ...
          <div className="flex w-full p-4 mx-auto justify-between items-center border-b border-[var(--color_text_title)]/30">
            <div className="flex gap-2 text-paragraph">
              <p className="pr-2 border-r border-[var(--color_text_title)]/30">
                ...
                {DataCommunityHealthCollaboration.author}
              </p>
              <p>
                <i className="ri-calendar-2-fill"></i>{" "}
                {DataCommunityHealthCollaboration.date}
              </p>
            </div>
          ...
          <h1 className="text-title font-bold py-10">
            {DataCommunityHealthCollaboration.title}
          </h1>
          <p className="text-paragraph text-justify whitespace-pre-line">
            {DataCommunityHealthCollaboration.mainDescription}
          </p>
        </div>

        {/* Foto kegiatan */}
        <div className="flex flex-col gap-12 w-full">
          {DataCommunityHealthCollaboration.activities.map((act, i) => (
...
export default CommunityHealthCollaboration;
