...
import DataSchoolMedicalRoom from "../Components/Data/DataSchoolMedicalRoom";

const SchoolMedicalRoom = () => {
  return (
        ...
        <div className="flex flex-col">
          <div className="py-10">
            <img
              ...
              src={DataSchoolMedicalRoom.mainImage}
              alt={DataSchoolMedicalRoom.title}
            />
          </div>
          ...
          <div className="flex w-full p-4 mx-auto justify-between items-center border-b border-[var(--color_text_title)]/30">
            <div className="flex gap-2 text-paragraph">
              <p className="pr-2 border-r border-[var(--color_text_title)]/30">
                ...
                {DataSchoolMedicalRoom.author}
              </p>
              <p>
                <i className="ri-calendar-2-fill"></i>{" "}
                {DataSchoolMedicalRoom.date}
              </p>
            </div>
          ...
          <h1 className="text-title font-bold py-10">
            {DataSchoolMedicalRoom.title}
          </h1>
          <p className="text-paragraph text-justify whitespace-pre-line">
            {DataSchoolMedicalRoom.mainDescription}
          </p>
        </div>

        {/* Foto kegiatan */}
        <div className="flex flex-col gap-12 w-full">
          {DataSchoolMedicalRoom.activities.map((act, i) => (
...
export default SchoolMedicalRoom;
