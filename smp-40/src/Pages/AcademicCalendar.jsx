...
import DataAcademicCalendar from "../Components/Data/DataAcademicCalendar";
        ...
        <div className="flex flex-col mx-auto w-full h-full">
          ...
          <div className="flex flex-col">
            <img
              ...
              alt={DataAcademicCalendar.title}
            />
          </div>
          ...
          <div className="flex w-full p-4 mx-auto justify-between items-center border-b border-[var(--color_text_title)]/30">
            <div className="flex gap-2 text-paragraph">
              <p className="pr-2 border-r border-[var(--color_text_title)]/30">
                <i className="ri-user-fill"></i> {DataAcademicCalendar.author}
              </p>
              <i className="ri-calendar-2-fill"></i> {DataAcademicCalendar.date}
            </div>
